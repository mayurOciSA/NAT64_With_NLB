...
output "nlb_nat64_ips" {
  value = [oci_network_load_balancer_network_load_balancer.nlb_nat64.assigned_ipv6, oci_network_load_balancer_network_load_balancer.nlb_nat64.assigned_private_ipv4]
}
